...
from mcp.models.task_schema import TaskDecompositionResult, SubTask
from mcp.utils.prompts import TASK_DECOMPOSITION_PROMPT
...
class TaskDecomposer:
    ...
    def decompose(self, user_input: str) -> TaskDecompositionResult:
        ...
        try:
            ...
            self.logger.info(f"任务分解完成，共分解为 {len(result.sub_tasks)} 个子任务")
